...
public interface MediaType {
	//public final static String LIBROS_API_USER = "application/vnd.beeter.api.user+json";
	//public final static String LIBROS_API_USER_COLLECTION = "application/vnd.beeter.api.user.collection+json";
